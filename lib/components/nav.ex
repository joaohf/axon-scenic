defmodule AxonScenic.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", AxonScenic.Scene.Sensor},
           {"Sensor (spec)", AxonScenic.Scene.SensorSpec},
           {"Primitives", AxonScenic.Scene.Primitives},
           {"Components", AxonScenic.Scene.Components},
           {"Transforms", AxonScenic.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
